...
export const navbarStyles = {
  ...
  mobilePanel: "absolute top-0 right-0 h-full w-4/5 max-w-xs mt-12 shadow-2xl transform transition-transform duration-500 ease-in-out",
  mobileHeader: "flex items-center justify-between p-5  border-slate-800",
