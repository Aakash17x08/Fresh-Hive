        ...
        <div className="login-card relative overflow-hidden rounded-3xl shadow-2xl">
          ...
          <div className="relative bg-gray-900 bg-opacity-80 backdrop-blur-xl p-8 rounded-3xl border border-emerald-700/30">
            ...
            <div className="flex justify-center mb-8">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-emerald-500 to-green-500 flex items-center justify-center shadow-lg">
                <div className="w-16 h-16 bg-emerald-800 rounded-full flex items-center justify-center">
                  <FaUser className="text-3xl text-emerald-400" />
                </div>
              </div>
            </div>
